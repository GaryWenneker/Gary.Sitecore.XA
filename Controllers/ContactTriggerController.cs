...
{
    public class ContactTriggerController : Controller
    {
        public ActionResult React()
        {

            ViewBag.Module = "Cito.default.ContactTrigger";//Would it be useful to transfer this information to the rendering?
